...
static const Rule rules[] = {
    ...
    */
    ...
    {"Godot", NULL, 1 << 1, 0, -1},   {"Brave", NULL, 1 << 2, 0, -1},
    {"firefox", NULL, 1 << 2, 0, -1}, {"Spotify", NULL, 1 << 3, 0, -1},
...
#define SHCMD(cmd)                                                             \
  {                                                                            \
    .v = (const char *[]) { "/usr/bin/sh", "-c", cmd, NULL }                   \
  }

/* commands */
static const char *termcmdzellij[] = {"foot", "sh", "-c", "zellij", NULL};
static const char *termcmd[] = {"foot", NULL};
static const char *menucmd[] = {"bemenu-run", "--fn", "IBM Plex Mono 12", NULL};

static const Key keys[] = {
    /* Note that Shift changes certain key codes: c -> C, 2 -> at, etc. */
    /* modifier                  key                 function        argument */
    {MODKEY, XKB_KEY_p, spawn, {.v = menucmd}},
    {MODKEY, XKB_KEY_g, spawn, SHCMD("grim -g \"$(slurp)\" - | wl-copy")},
    {MODKEY | WLR_MODIFIER_CTRL, XKB_KEY_l, spawn, SHCMD("waylock")},
    {MODKEY, XKB_KEY_s, spawn,
     SHCMD(
         "grim -g - \"$(slurp)\" $HOME/Pictures/Screenshots/$(date +%s).png")},
