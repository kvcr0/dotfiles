...
local bg = hsl(245, 30, 10)
-- local bg = hsl(0, 0, 0)
local fg = hsl(220, 30, 75)
local yellow = hsl(60, 100, 50)
local green = hsl(160, 78, 60)
local blue = hsl(195, 100, 60)
local orange = hsl(40, 80, 75)
local g = hsl(100, 80, 60)
-- local red = hsl(345, 90, 60)
local red = hsl(335, 70, 60)
local pink = hsl(315, 90, 70)
-- local purple = hsl(285, 100, 60)
local purple = hsl(280, 70, 65)
...
local theme = lush(function(injected_functions)
    ...
    return {
        ...
        -- sym"@tag"               { }, -- Tag
        Normal { bg = bg, fg = fg },
        NormalFloat { bg = bg.li(20), fg = fg },
        CursorLine { bg = bg.li(10) },
        Visual { bg = CursorLine.bg, fg = fg.ro(100) },
        Comment { fg = bg.sa(70).li(60), gui = 'italic' },
        Type { fg = g, gui = 'italic' },
        Identifier { fg = hsl(0, 0, 100) },
        Function { fg = blue, gui = 'italic' },
        -- Function { fg = purple.li(30), gui = 'italic' },
        Operator { fg = blue, gui = 'normal' },
        Statement { fg = purple.sa(-40).li(30), gui = 'italic' },
        -- Statement { fg = purple, gui = 'italic' },
        -- Statement { fg = green },
        -- Conditional { fg = red }, --   if, then, else, endif, switch, etc.
        Special { fg = hsl(0, 0, 100), gui = 'italic' },
        ...
        Structure { fg = green },
        Title { fg = purple, gui = 'bold' }, -- Titles for output from ":set all", ":autocmd" etc.
        sym "@constant.builtin" { fg = orange },
        -- sym "@parameter" { fg = red },
        sym "@namespace" { fg = Structure.fg, gui = 'underline' },       -- Identifier
